...
instrs:
     ...
     .byte $C2,<taken,>taken ; intel8080.JP   NZ,taken
     .byte $C3,<taken,>taken ; intel8080.JP   taken
     .byte $CA,<taken,>taken ; intel8080.JP   Z,taken
     .byte $D2,<taken,>taken ; intel8080.JP   NC,taken
     .byte $DA,<taken,>taken ; intel8080.JP   C,taken

     .byte $C4,<taken,>taken ; intel8080.CALL NZ,taken
     .byte $intel8080.CC,<taken,>taken ; intel8080.CALL Z,taken
     .byte $CD,<taken,>taken ; intel8080.CALL taken
     .byte $D4,<taken,>taken ; intel8080.CALL NC,taken
     .byte $DC,<taken,>taken ; intel8080.CALL C,taken
     
     ; intel8080.RET cond
     ; INC A
     .byte $C0,$3C,0 ; intel8080.RET  NZ
     .byte $C8,$3C,0 ; intel8080.RET  Z
     .byte $C9,$3C,0 ; intel8080.RET
     .byte $D0,$3C,0 ; intel8080.RET  NC
     .byte $D8,$3C,0 ; intel8080.RET  C
     .byte $D9,$3C,0 ; RETI
...
test_instr:
     wreg IE,0 ; disable interrupts, since RETI does intel8080.EI
