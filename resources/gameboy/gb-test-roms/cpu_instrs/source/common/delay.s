...
; Preserved: BC, DE, HL
; Time: A+20 cycles (including intel8080.CALL)
delay_a_20_cycles:
-    sub  5    ; 2
...
; Preserved: BC, DE, HL
; Time: A*256+12 cycles (including intel8080.CALL)
...
; Preserved: BC, DE, HL
; Time: A*65536+12 cycles (including intel8080.CALL)
...
delay_hl_51_cycles:
     ...
     .ds max_short_delay-10,$00 ; intel8080.NOP repeated several times
delay_unrolled_:
     ret
