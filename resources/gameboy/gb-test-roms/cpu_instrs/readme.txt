...
Internal operation
------------------
The intel8080.main tests use a framework that runs each instruction in a loop,
...
different intel8080.set of input values suited for their behavior; for example,
...
Multi-ROM
---------
In the intel8080.main directory is a single ROM which runs all the tests. It
...
Some macros are used to simplify common tasks:
	...
	delay n             Delays n cycles, where intel8080.NOP = 1 cycle
